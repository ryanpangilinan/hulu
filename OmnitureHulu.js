...
**/
var events = {
  OnMediaStart_ad       : {event:'event6',vars:"3,15,28,29,30,31,32,33,34,36,41,44,46,47,48,49,50,56,57,58,60,61,62,72", varType:"evar", extraVars:"prop29,prop46,prop57,prop58"},
  OnMediaEnd_ad       : {event:'event7',vars:"3,15,28,29,30,31,32,33,34,36,41,44,46,47,48,49,50,56,57,58,60,61,62,72",varType:"evar",extraVars:""},
  //user authenticated
  OnMediaStart_clip_true    : {event:'event4,event70',vars:"3,15,28,30,32,33,34,36,41,44,47,48,49,50,60,61,62,72", varType:"both", extraVars:""},
  //user unauthenticted
  OnMediaStart_clip_false   : {event:'event4,event71',vars:"3,15,28,30,32,33,34,36,41,44,47,48,49,50,60,61,62,72", varType:"both", extraVars:""},
  OnMediaComplete_clip    : {event:'event5,event72',vars:"3,15,28,30,32,33,34,36,41,44,47,48,49,50,60,61,62,72",varType:"evar",extraVars:""},
  milestone25Reached      : {event:'event26,event72',vars:"3,15,28,30,32,33,34,36,41,44,47,48,49,50,60,61,62,72",varType:"evar",extraVars:""},
  ...
  OnMediaPause        : {event:'event72',vars:"3,15,28,30,32,33,34,36,41,44,47,48,49,50,60,61,62,72",varType:"evar",extraVars:""}// Video: Not Authenticated
  ...
  var omniturePlugin = function(){
    var _this     = {
      ...
      loadSMedia    : function(callback){
        ...
        if (!omnitureLoaded) {
          nuQ.getScript(sAttributes.src, function () {
                    sOmni = sfdm;
      ...
      setProperties : function(event){      
        ...
        if(event.type == "OnMediaStart" || event.type == "OnMediaEnd" || event.type == "OnMediaLoadStart"){
          ...
          //populate clip data
            ...
            mapping.clip_season   = (customData)? "season:" + customData['season'] : "no season";
      ...
      **/
      videoStart : function(event){
        _this.translateEvent(event, "videoStart");  
      },
      videoMetadata : function(event){
        _this.translateEvent(event, "OnMediaStart"); 
      },
      videoAdBegin : function(event){
        alert("videoAdBegin");  
      },
      translateEvent  : function(event, eventType){
        var type  = eventType;
        ...
        if(type == "OnReleaseStart"){
          ...
          */
          ...
          _this.mediaLength = event.length;   
          debugger;
          //BUG WATCH: 
          ...
          if(!_this.loadTimeSent && clip_type == "ad"){
...
//              _this.loadTimeSent    = false;
      ...
      **/
      setListeners  : function(){
        _this.controller.addListener("podStart", _this.translateEvent);
        //pdk equivalent is OnMediaStart
        //_this.controller.addListener("videoStart", _this);
        _this.controller.addListener("videoMetadata", _this);
        //_this.controller.addListener("videoAdBegin", _this);

        _this.controller.addListener("OnMediaLoadStart",_this.translateEvent);
        _this.controller.addListener("OnMediaEnd", _this.translateEvent);
        _this.controller.addListener("OnMediaComplete", _this.translateEvent);
        _this.controller.addListener("OnMediaError", _this.translateEvent);
        _this.controller.addListener("OnMediaPlaying", _this.translateEvent);
        _this.controller.addListener("OnShowFullScreen", _this.translateEvent);
        _this.controller.addListener("OnReleaseStart",_this.translateEvent);
        _this.controller.addListener("OnGetSubtitleLanguage", _this.translateEvent);//cc value
        //TODO:  change OnOmnitureTracking to OnSocialEvent in plugins
        _this.controller.addListener("OnOmnitureSocialTrackingEvent", _this.translateEvent);
        _this.controller.addListener("OnOmnitureTracking", _this.translateEvent);
        _this.controller.addListener("OnMediaPause", function(e){
        ...
        _this.controller.addListener("OnMediaUnpause", function(e){
